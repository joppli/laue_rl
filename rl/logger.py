...
COMMON_TRAIN_FORMAT = [('frame', 'F', 'int'), ('step', 'S', 'int'), ('buffer_size', 'BS', 'int'), 
                       ('episode', 'E', 'int'), ('total_time', 'T', 'time'), ('fps', 'FPS', 'float'),
                       ('episode_length', 'L', 'int'), ('episode_reward', 'R', 'float'), ('success_rate', 'SR', 'float'),]

COMMON_EVAL_FORMAT = [('frame', 'F', 'int'), ('step', 'S', 'int'), 
                      ('episode', 'E', 'int'), ('total_time', 'T', 'time'),
                      ('episode_length', 'L', 'int'), ('episode_reward', 'R', 'float'), ('success_rate', 'SR', 'float'), 
                      ('out_of_range_rate', 'OORR', 'float')]
